...
/// <summary>
/// DbContext para la API Local. Utiliza PostgreSQL.
/// Es la base de datos local de cada sucursal/punto de venta.
/// </summary>
public class LocalContext : DbContext
{
    ...
    // Seguridad
    public DbSet<BaresFamilia.Core.Models.Entities.Seguridad.DispositivoActivacion> DispositivosActivacion => Set<BaresFamilia.Core.Models.Entities.Seguridad.DispositivoActivacion>();
